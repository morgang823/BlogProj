    ...
    */
    ...
    value: function insertImagesAsDataURL(files) {
      ...
      external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.each(files, function (idx, file) {
        ...
        if (_this4.options.maximumImageDataSize && _this4.options.maximumImageDataSize < file.size) {
...
var ImageDialog_ImageDialog = /*#__PURE__*/function () {
  ...
  ImageDialog_createClass(ImageDialog, [{
    ...
    value: function initialize() {
      ...
      if (this.options.maximumImageDataSize) {
        var unit = Math.floor(Math.log(this.options.maximumImageDataSize) / Math.log(1024));
        var readableSize = (this.options.maximumImageDataSize / Math.pow(1024, unit)).toFixed(2) * 1 + ' ' + ' KMGTP'[unit] + 'B';
